...
class PhotoMessagePrototype(InputMediaPrototype, ABC):
    @abstractmethod
    async def get_photo(self, dialog: "DialogOperator", context: Optional[dict[str, Any]]) -> Union[str, InputFile]:
        pass
    ...
    async def get_input_media(self, dialog: "DialogOperator", context: Optional[dict[str, Any]], parse_mode=None) -> InputMediaPhoto:
